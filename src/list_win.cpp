...
LRESULT CALLBACK WndProc(HWND hWnd,UINT msg,WPARAM wParam,LPARAM lParam)
{
    ...
    case WM_CREATE:
    	...
    	//ComboBox1
    	//tworzenie ComboBox1
    	hComboBox1 = CreateWindowEx(WS_EX_CLIENTEDGE, "COMBOBOX", NULL, WS_CHILD | WS_VISIBLE | WS_BORDER | CBS_DROPDOWNLIST |
	    CBS_DROPDOWN, 150, 60, 150, 200, hWnd, NULL, *hInst, NULL);
    	...
    	//ComboBox2
    	//tworzenie ComboBox2
    	hComboBox2 = CreateWindowEx( WS_EX_CLIENTEDGE, "COMBOBOX", NULL, WS_CHILD | WS_VISIBLE | WS_BORDER | CBS_DROPDOWNLIST |
    	CBS_DROPDOWN, 150, 110, 150, 200, hWnd, NULL, *hInst, NULL );
    	...
    	//ComboBox4
    	//tworzenie ComboBox4
    	hComboBox4 = CreateWindowEx( WS_EX_CLIENTEDGE, "COMBOBOX", NULL, WS_CHILD | WS_VISIBLE | WS_BORDER | CBS_DROPDOWNLIST |
    	CBS_DROPDOWN, 150, 210, 150, 250, hWnd, NULL, *hInst, NULL );
