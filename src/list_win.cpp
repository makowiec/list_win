...
int WINAPI WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow )
{
	...
	//tworzenie okna rodzica
	  ...
	  HWND hStaticText1=CreateWindowEx(
			  0,
			  "STATIC",
			  NULL,
	  ...
	  HWND hStaticText2=CreateWindowEx(0,
			  "STATIC",
			  NULL,
			  WS_CHILD | WS_VISIBLE | SS_LEFT,
			  50,
	  ...
	  HWND hStaticText3=CreateWindowEx(
			  0,
			  "STATIC",
			  NULL,
			  WS_CHILD | WS_VISIBLE | SS_LEFT,
	  ...
	  HWND hStaticText4=CreateWindowEx(
			  0,
			  "STATIC",
			  NULL,
			  WS_CHILD | WS_VISIBLE | SS_LEFT,
...
LRESULT CALLBACK WndProc(HWND hWnd,UINT msg,WPARAM wParam,LPARAM lParam)
{
    ...
    case WM_CREATE:
    	...
    	//ComboBox1
    	//tworzenie ComboBox1
    	hComboBox1=CreateWindowEx(
    			WS_EX_CLIENTEDGE,
				"COMBOBOX",
				NULL,WS_CHILD | WS_VISIBLE | WS_BORDER | CBS_DROPDOWNLIST | CBS_DROPDOWN,
				150,
				60,
				150,
				200,
    	...
    	//ComboBox2
    	//tworzenie ComboBox2
    	hComboBox2=CreateWindowEx(
    			WS_EX_CLIENTEDGE,
				"COMBOBOX",
				NULL,
				WS_CHILD | WS_VISIBLE | WS_BORDER | CBS_DROPDOWNLIST | CBS_DROPDOWN,
				150,
				110,
				150,
				200,
